...
struct insert_at_back_of_sll
{
  ...
  void operator()( const SomeObject & object )
  {
    ...
    my_sll.insert_after( prev, std::move( object ) );
...
struct insert_into_bst
{
  ...
  void operator()( const SomeObject & object )
  {
    ///////////////////////// TO-DO (7) //////////////////////////////
      ...
      my_bst.emplace( object.upcCode(), std::move( object ) );
...
struct insert_into_hash_table
{
  ...
  void operator()( const SomeObject & object )
  {
    ///////////////////////// TO-DO (8) //////////////////////////////
      ...
      my_hash_table.emplace( object.upcCode(), std::move( object ) );
...
struct remove_from_hash_table
{
  ...
  void operator()( const SomeObject & object )
  {
    ///////////////////////// TO-DO (16) //////////////////////////////
      ...
      {
        my_hash_table.erase( object.upcCode() );
      }
...
struct search_within_vector
{
  ...
  SomeObject * operator()( const auto & )
  {
    ///////////////////////// TO-DO (17) //////////////////////////////
      ...
      for ( auto obj = my_vector.begin(); obj !=  my_vector.end(); ++obj )
      {
        if ( obj->upcCode() == target_key ){
          return  &(* obj);
        }
      }
...
struct search_within_dll
{
  ...
  SomeObject * operator()( const auto & )
  {
    ///////////////////////// TO-DO (18) //////////////////////////////
      ...
      for ( auto obj = my_dll.begin(); obj != my_dll.end(); ++obj ) {
        if ( obj->upcCode() == target_key ){
          return &(*obj);
        }
      }
...
struct search_within_sll
{
  ...
  SomeObject * operator()( const auto & )
  {
    ...
    for ( auto obj = my_sll.begin(); obj != my_sll.end(); ++obj ){
      if ( obj->upcCode() == target_key )
      {
        return &(*obj);
      }
...
struct search_within_bst
{
  ...
  SomeObject * operator()( const auto & )
  {
    ...
    auto obj = my_bst.find( target_key );
...
struct search_within_hash_table
{
  ...
  SomeObject * operator()( const auto & )
  {
    ...
    auto obj = my_hash_table.find( target_key );

      if ( obj != my_hash_table.end() )
      {
        return &obj->second;
      }
